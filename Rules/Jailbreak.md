...
1. ## Definitions
	...
	15. Snitching: Telling the guards negative information about a fellow T, e.g. "Warden, Citizen has a gun" is snitching while "Warden, there's a gun infront of the marker" is not snitching
...
2. ## Global Rules
	...
	13. The first round is always a programmed free day. Guards cannot give any orders excluding orders to drop guns, move away from a guard they are getting too close too, etc.
	...
	19. Any incidents or rule breaking that happens in one round cannot have an effect on any rounds after. For example, a prisoner got free killed in the round and requested a free day for the next round cannot be permitted.
	...
	25. No detours and delays implies on all commands. This also applies to Special days too, eg you can't just camp until you're last alive.
	26. No cheating implies on all commands.
...
3. ## Newcomer Rules
	1. Newcomer -- A Newcomer is a new player (with playtime less than 4 hours for a Prisoner, under 20 round wins for a Guard), who’s playermodel is tinted green when not set to a different colour.
...
3. ## Rules for Prisoners
	...
	17. On a freeday, camping outside of the armoury to trap guards inside will result in being warningshot then made KOS.
...
4. ## Rules For Guards
	...
	3. Guards cannot enter the vents unless they are sure a prisoner has gone inside or is currently inside. (You do not have to follow the same enterance, so long as you do not break any other vent related rules)
...
7. ## Special Days
	...
	10. Nightcrawler - Have a laser that is green and CT’s are invisible and if a CT is in front of a t their laser goes red.
